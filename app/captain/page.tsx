 ...
 * 
 * The entry point for Captains.
 * Provides a simple lookup interface to find and edit a specific work order by its ID.
 */
"use client";
...
/**
 * CaptainLanding Component
 * 
 * Renders a minimal dashboard for Captains.
 * Features:
 * - A simple form to enter a Work Order ID.
 * - Redirects the user to the Captain-specific edit view for that order.
 * - Includes a prominent Sign Out button.
 */
